...
local function on_lsp_attach(event)
  ...
  vim.keymap.set("n", "grr", function()
    require("config.pickers").lsp_references()
  end, { buffer = event.buf, desc = "LSP: [G]oto [R]eferences" })
  vim.keymap.set("n", "gri", function()
    require("config.pickers").lsp_implementations()
  end, { buffer = event.buf, desc = "LSP: [G]oto [I]mplementation" })
  vim.keymap.set("n", "gd", function()
    require("config.pickers").lsp_definitions()
  ...
  vim.keymap.set("n", "grs", function()
    require("config.pickers").lsp_symbols()
  end, { buffer = event.buf, desc = "LSP: Open Document Symbols" })
  vim.keymap.set("n", "grt", function()
    require("config.pickers").lsp_type_definitions()
